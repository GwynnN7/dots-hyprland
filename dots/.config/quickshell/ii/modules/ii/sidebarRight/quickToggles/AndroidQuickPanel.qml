...
AbstractQuickPanel {
    ...
    // Toggles
    readonly property list<string> availableToggleTypes: ["network", "bluetooth", "idleInhibitor", "easyEffects", "nightLight", "darkMode", "performanceMode", "screenSnip", "colorPicker", "onScreenKeyboard", "mic", "audio", "notifications", "musicRecognition", "antiFlashbang", "cortanaLight", "motionDetection"]
